...
export class Client extends AbstractClient {
    ...
    async DescribePatchEffectHostList(req, cb) {
    ...
    async DescribeWindowsPatchList(req, cb) {
    ...
    async DescribePatchInfo(req, cb) {
    ...
    async ExportWindowsPatchList(req, cb) {
    ...
    async ExportPatchEffectHostList(req, cb) {
