...
export declare class Client extends AbstractClient {
     ...
     * 查询补丁影响的主机信息列表
     */
    DescribePatchEffectHostList(req: DescribePatchEffectHostListRequest, cb?: (error: string, rep: DescribePatchEffectHostListResponse) => void): Promise<DescribePatchEffectHostListResponse>;
    /**
     ...
     * 获取补丁信息列表
     */
    DescribeWindowsPatchList(req: DescribeWindowsPatchListRequest, cb?: (error: string, rep: DescribeWindowsPatchListResponse) => void): Promise<DescribeWindowsPatchListResponse>;
    /**
...
预付费订单仅下单不支付,需要调用计费支付接口进行支付
     ...
     * 补丁详情
     */
    DescribePatchInfo(req: DescribePatchInfoRequest, cb?: (error: string, rep: DescribePatchInfoResponse) => void): Promise<DescribePatchInfoResponse>;
    /**
     * 删除木马白名单
     */
...
3）给定quuid列表，scope为0，quuids为用户选择quuid
     ...
     * 导出Windows补丁列表
     */
    ExportWindowsPatchList(req: ExportWindowsPatchListRequest, cb?: (error: string, rep: ExportWindowsPatchListResponse) => void): Promise<ExportWindowsPatchListResponse>;
    /**
     * 删除基线弱口令
     */
     ...
     * 导出补丁影响主机列表
     */
    ExportPatchEffectHostList(req: ExportPatchEffectHostListRequest, cb?: (error: string, rep: ExportPatchEffectHostListResponse) => void): Promise<ExportPatchEffectHostListResponse>;
    /**
     * 导出反弹Shell事件
     */
